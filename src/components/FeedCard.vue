<template>
  <div class="w-1/2 flex flex-col-reverse mx-auto">
    <div
      ...
      :key="feed"
      class="bg-slate-200 my-2 p-6 grid rounded-lg"
    >
      <div class="flex">
        <div>
          <Avatar :photo="feed.photo" />
        </div>
        <div class="grid ml-4 grid-flow-row">
          ...
          <div class="mt-3 flex">
            <div class="flex hover:cursor-pointer" @click="toggle(index)">
              <div v-if="feed.heart">
                <svg
                  width="24"
                  height="24"
            ...
            <div class="mt-[2px] ml-2 h-7" @click="retweet(index)">
              <svg
                width="25"
                height="19"
                viewBox="0 0 25 19"
...
export default {
  ...
  methods: {
    toggle(index) {
      ...
      if (this.feeds[index].heart == false) {
